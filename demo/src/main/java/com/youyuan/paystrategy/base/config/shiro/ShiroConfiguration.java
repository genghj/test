package com.youyuan.paystrategy.base.config.shiro;
...
//        ((DefaultSessionStorageEvaluator)((DefaultSubjectDAO)securityManager.getSubjectDAO()).getSessionStorageEvaluator()).setSessionStorageEnabled(false);
     ...
     * 配置以下三个bean LifecycleBeanPostProcessor 、(DefaultAdvisorAutoProxyCreator(必须选)和AuthorizationAttributeSourceAdvisor)即可实现此功能
     * @return
     */
    @Bean
